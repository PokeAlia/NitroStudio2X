...
namespace NitroStudio2.FindReplaceDialog.FindAllResults
{
    public partial class FindAllResultsPanel : UserControl
    {
        ...
        public void UpdateFindAllResults(FindReplace.FindReplace FindReplace, List<CharacterRange> FindAllResults)
        {
            ...
            _findAllResults = new List<CharacterRange>(FindAllResults);
        ...
        private void FindResultsScintilla_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                CharacterRange CharRange = _findAllResults[selectedLine];
